...
const Properties = () => {
  ...
  useEffect(() => {
    ...
    if (priceRange[0] !== 800000 || priceRange[1] !== 1200000) {
      newActiveFilters.push(`Price: $${(priceRange[0]/1000).toFixed(1)}K - $${(priceRange[1]/1000).toFixed(1)}K`);
    }
    if (yieldRange[0] !== 6 || yieldRange[1] !== 9) {
  ...
  }, [searchValue, priceRange, yieldRange, selectedTypes, properties, sortOption]);
    ...
    <div className="min-h-screen">
      ...
      <div className="pt-24 pb-10 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="container mx-auto">
          <h1 className="text-3xl font-bold text-gray-900">Global Property Investments</h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {['Residential', 'Commercial', 'Vacation Rental'].map((type) => (
