...
const AdminDashboard = () => {
  ...
  const filteredVendors =
    vendorFilter === "all"
      ? vendors
      : vendors.filter((vendor) => vendor.status === vendorFilter);
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{adminParams.total_users}</div>
                  <div className="flex justify-between pt-3">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{adminParams.support_count}</div>
                  <div className="flex justify-between pt-3">
                    <p className="text-xs flex items-center text-muted-foreground font-semibold text-red-400">
                    ...
                    <p className="text-xs flex items-center font-semibold text-green-600 ">
                    {adminParams.formattedTicketStatusCounts.resolved||0} resolved
                    ...
                    <tbody>
                      {filteredVendors.map((vendor) => (
                        <tr
                          ...
                          className="bg-white border-b hover:bg-gray-50"
                        >
                          <td className="px-6 py-4 font-medium">{vendor.id}</td>
                          <td className="px-6 py-4">{vendor.name}</td>
                          <td className="px-6 py-4">{vendor.type}</td>
                          <td className="px-6 py-4">{vendor.properties}</td>
                          <td className="px-6 py-4">
                            <span
                              className={`px-2 py-1 rounded-full text-xs ${getStatusColor(
                                vendor.status
